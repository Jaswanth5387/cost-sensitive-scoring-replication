...
| Tableau: "Cost Sensitive Classifiers for Better Machine Learning Decision-Making" | General decision systems | Medium: explains design pattern | No precise reproduction target recorded | Likely too conceptual; may lack numeric claims | likely reject |
| Medium: "Fraud detection with cost-sensitive machine learning" | Fraud | Unknown | No precise reproduction target recorded | Platform and source details need verification; may be tutorial rather than production report | investigate |
